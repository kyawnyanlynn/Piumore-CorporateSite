...
const RecruitAbout = () => {
  return (
    <div className="px-[5%] sm:px-[10%] mx-auto">
      <h2 className="text-center text-2xl sm:text-4xl font-bold my-16">
        私たちはコンセプトの
        <br />
        異なる3つの店舗を運営しています。
      </h2>
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-10">
        <div>
          ...
          <p className="font-medium leading-7 text-[#232121f9]">
        ...
        <div>
          ...
          <p className="font-medium leading-7 text-[#232121f9]">
            歌舞伎の演目にも登場する伝統味噌を使い江戸時代のレシピを再現した江戸前すき焼きが名物のお店。
