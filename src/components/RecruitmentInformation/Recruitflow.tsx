...
const Recruitfow = () => {
  return (
    <div className="w-full  flex flex-col items-center mb-[60px]">
      <h2 className="text-2xl sm:text-4xl mb-20 font-semibold">選考フロー</h2>
      <div className="relative w-full max-w-xl">
        ...
        <div className="flex flex-col gap-10 mx-4 ">
          {steps.map((step, index) => (
            <div
              key={index}
              className="relative bg-[#B42423] text-white rounded-xl py-6 pl-16 pr-8 w-full"
            >
              <p className="text-2xl sm:text-3xl font-bold absolute left-6 top-1/2 -translate-y-1/2">
                {step.number}
              </p>
